...
def get_config():
    ...
    arch.pyramid.num_levels = 3             # 4-5 levels is usually sufficient for 1D AC; 7 might be overkill/slower
    arch.pyramid.base_resolution = 64        # Start slightly coarser
    arch.pyramid.feature_dim = 24           # 256 is very heavy for 1D; 64 or 128 is usually enough
