...
def get_config():
    ...
    wandb.name = "grid_1+1D_tanh_reparam4"
    wandb.tag = None
    ...
    arch.pyramid.num_levels = 5             # 4-5 levels is usually sufficient for 1D AC; 7 might be overkill/slower
    arch.pyramid.base_resolution = 4        # Start slightly coarser
